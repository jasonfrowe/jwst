...
!Target information                              
call ftpkyd(funit,'TARG_RA',188.38685d0,5,'/ Target RA at mid time of exposure',status)
call ftpkyd(funit,'TARG_DEC',-10.14617305555556d0,15,'/ Target Dec at mid time of exposure',status)  
...
call ftpkyd(funit,'TFRAME',5.491d0,3,'/ [s] Time between frames',status)                        
call ftpkyd(funit,'TGROUP',5.491d0,3,'/ [s] Time between groups',status)                  
call ftpkyd(funit,'DURATION',0.0d0,1,'/ [s] Total duration of exposure',status)                         
!Subarray parameters                                                                           
